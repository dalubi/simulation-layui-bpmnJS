...
public class generateUtils {
    ...
    public static String creteFedPath(String fileName) {
        String str = "src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\" + fileName + ".txt";
        return str;
    }

    public static String creteCommonsPath(String fileName) {
        String str = "src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Commons\\" + fileName + ".txt";
        return str;
    }

    public static String creteFederatePath(String fileName) {
        String str = "src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Federates\\" + fileName + ".txt";
        return str;
    }

    public static String creteAbstractPath(String fileName) {
        String str = "src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Abstract\\" + fileName + ".txt";
        return str;
    }
    ...
    public static void changeAll() {
        changeSuffixName("src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Commons\\");
        changeSuffixName("src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Federates\\");
        changeSuffixName("src\\main\\java\\com\\ices\\simulation\\cyf\\generate\\Abstract\\");
    }
