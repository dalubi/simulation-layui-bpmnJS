...
public class GraphNode {
   private String graphId;
    ...
    //交互类信息 收到的交互类
    private String receiveInteractionInformation;
    //交互类信息 发送的交互类
    private String sendInteractionInformation;

    public String getReceiveInteractionInformation() {
        return receiveInteractionInformation;
    }

    public void setReceiveInteractionInformation(String receiveInteractionInformation) {
        this.receiveInteractionInformation = receiveInteractionInformation;
    }
    ...
    public String getSendInteractionInformation() {
        return sendInteractionInformation;
    }

    public void setSendInteractionInformation(String sendInteractionInformation) {
        this.sendInteractionInformation = sendInteractionInformation;
    }
    ...
    public String toString() {
        return "GraphNode{" +
                ...
                ", stateNeighborList=" + stateNeighborList +
                ", receiveInteractionInformation='" + receiveInteractionInformation + '\'' +
                ", sendInteractionInformation='" + sendInteractionInformation + '\'' +
                '}';
    }
